        ...
        <div class="row">
            <div class="col-md-4 offset-md-4 form login-form">
                <form action="login-admin.php" method="POST" autocomplete="">
                    <h2 class="text-center">Login Admin Form</h2>
                    ...
                    <div class="link forget-pass text-left"><a href="login-user.php">Not an admin? Login as Customer</a></div>
                    <div class="form-group">
                        <input class="form-control button" type="submit" name="login_admin" value="Login">
                    </div>
                </form>
            </div>
            <div id="message">
